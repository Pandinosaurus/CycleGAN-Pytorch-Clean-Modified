...
# Inputs & targets memory allocation - fixed [1 x 1] vs [1] issue : python now considers scalar [1] != from singleton [1x1]
# the fix was to change the tensor definition below thanks to https://github.com/aitorzip/PyTorch-CycleGAN/pull/4/commits/fe7845a16503b721f13602d9914a7ee00a7881ed
